...
import { TypographyH1, TypographyLead, TypographyMuted, TypographySmall } from "@ui/shadcn/typography";
    ...
    return (<div className="">
        ...
        >
            <div className="flex h-full w-full flex-col gap-4 px-8 py-36 pb-20 lg:px-16 lg:py-44 ">
                ...
                <div
                    className="flex w-max items-center gap-3 rounded-full border border-neutral-300/70 bg-neutral-200/80 p-1 pl-2">
                    <TypographyMuted className="">Learn more about our gift choices</TypographyMuted>
                    <VyaLink
                ...
                <TypographyH1 className="md:leading-14">
                    Gift Joy, Share Peace, <br className="hidden sm:block" />  Celebrate Life - <span className='text-accent'>Vyadove</span>
                </TypographyH1>

                <TypographyLead className="text-foreground max-w-2xl text-lg font-normal">
                    Vyadove is Africa’s premier experience gifting platform. We help you connect with loved ones
                    through unforgettable experiences — from spa days and fine dining to adventures and retreats.
                </TypographyLead>
