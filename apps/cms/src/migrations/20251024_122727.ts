...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "support_page_id" integer;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "main_menu_blocks_form_block" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "main_menu_nav_items" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "main_menu" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "main_menu_rels" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_support_page_fk";
  ...
  DROP INDEX "payload_locked_documents_rels_support_page_id_idx";
  ...
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "support_page_id";
