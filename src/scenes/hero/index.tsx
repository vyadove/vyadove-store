...
import { TypographyH1, TypographyMuted, TypographyP, TypographySmall } from "@ui/shadcn/typography";
...
const Hero = () => {
	...
	return (
		<div className="">
			...
			>
				<div className="flex h-full w-full flex-col gap-4 px-8 py-36 pb-40 lg:px-16 lg:py-44 ">
