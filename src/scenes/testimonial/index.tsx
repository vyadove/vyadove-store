...
import { TypographyH1, TypographyLarge, TypographyLead, TypographyMuted } from "@ui/shadcn/typography";
import Image from "next/image";
import type React from "react";
import Marquee from "react-fast-marquee";
import { AiOutlineArrowLeft, AiOutlineArrowRight } from "react-icons/ai";
import { FiDatabase, FiLayers, FiMessageSquare, FiTarget } from "react-icons/fi";
...
const Testimonial = () => {
	return (
		<InvertedCornerMask
			className="mt-24 w-full bg-green-700/10"
			cornerContent={
				<div className="flex items-center justify-center gap-2 p-6">
					<Button className="bg-green-700/30 text-black md:size-14" size="icon-lg">
		...
		>
			<div className="flex h-full w-full flex-col gap-4 p-4 md:p-24">
				<section className="mx-auto flex max-w-6xl flex-col items-center text-center">
					...
					<div className="flex flex-col items-center">
						<div className="size-24 overflow-hidden rounded-full shadow ring-2 ring-white">
							<Image alt="Aster Awoke" className="h-full w-full object-cover" src={Person} />
						</div>
						<div className="mt-4">
					...
					{/* Helper line */}
					<TypographyLead className="mt-20">Trusted by over 50+ companies worldwide</TypographyLead>
