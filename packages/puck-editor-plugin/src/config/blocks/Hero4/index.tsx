...
export const Hero4: ComponentConfig<Hero4Props> = {
    ...
    render: ({ title, primaryButtonText, primaryButtonHref, secondaryButtonText, secondaryButtonHref, backgroundImage, puck }) => {
        return (
                ...
                <div className={styles.container}>
                    <div className={`${styles.row} ${styles.alignItemsCenter} ${styles.justifyContentCenter} ${styles.textCenter}`}>
                        <div className={styles.colLg8}>
                            <h1 className={`${styles.heading} ${styles.textWhite} ${styles.mb3}`}>{title}</h1>
