...
const payloadCloudReplacement: StorageAdapterReplacement = {
    ...
    importReplacement:
        "import { payloadCloudPlugin } from '@shopnex-ai/shopnex-cloud'",
    packageName: "@shopnex-ai/shopnex-cloud",
};
...
export const storageReplacements: Record<
    StorageAdapterType,
    StorageAdapterReplacement
> = {
