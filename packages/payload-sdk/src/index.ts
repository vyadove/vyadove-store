...
import type { ForgotPasswordOptions } from "./auth/forgotPassword";
import type { LoginOptions, LoginResult } from "./auth/login";
import type { MeOptions, MeResult } from "./auth/me";
import type {
...
import type { FindByIDOptions } from "./collections/findByID";
import type { FindVersionByIDOptions } from "./collections/findVersionByID";
import type { FindVersionsOptions } from "./collections/findVersions";
import type { RestoreVersionByIDOptions } from "./collections/restoreVersion";
import type { FindGlobalVersionByIDOptions } from "./globals/findVersionByID";
import type { FindGlobalVersionsOptions } from "./globals/findVersions";
import type { RestoreGlobalVersionByIDOptions } from "./globals/restoreVersion";
...
import type { OperationArgs } from "./utilities/buildSearchParams";
...
import { findGlobal, type FindGlobalOptions } from "./globals/findOne";
import { findGlobalVersionByID } from "./globals/findVersionByID";
import { findGlobalVersions } from "./globals/findVersions";
import { restoreGlobalVersion } from "./globals/restoreVersion";
import { updateGlobal } from "./globals/update";
import { buildSearchParams } from "./utilities/buildSearchParams";
...
> {
    ...
    findVersions<TSlug extends CollectionSlug<T>>(
        ...
        PaginatedDocs<TypeWithVersion<DataFromCollectionSlug<T, TSlug>>>
    > {
