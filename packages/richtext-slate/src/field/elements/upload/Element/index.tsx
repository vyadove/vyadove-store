...
const UploadElementComponent: React.FC<{
    ...
    const [relatedCollection, setRelatedCollection] =
    ...
    const [ListDrawer, ListDrawerToggler, { closeDrawer: closeListDrawer }] =
        useListDrawer({
            ...
            <div className={`${baseClass}__card`}>
                <div className={`${baseClass}__topRow`}>
                    ...
                    <div className={`${baseClass}__thumbnail`}>
                        {thumbnailSRC ? (
                            <img alt={data?.filename} src={thumbnailSRC} />
                        ) : (
                            <File />
                        )}
                    </div>
                            ...
                            {Boolean(customFieldsMap) && (
                                <>
                                    <DrawerToggler
                                        ...
                                        disabled={
                                            fieldProps?.field?.admin?.readOnly
                                        }
                                        slug={drawerSlug}
                                    >
                                        <Button
