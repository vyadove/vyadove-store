    ...
    return [
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        },
                        {
                            ...
                            admin: {
                                components: {
                                    Field: "@shopnex/import-export-plugin/rsc#SortBy",
                                },
                            },
                        },
                    ],
                ...
                },
                {
                    ...
                    admin: {
                        components: {
                            Field: "@shopnex/import-export-plugin/rsc#FieldsToExport",
                        },
                    },
                    hasMany: true,
                },
                {
                    ...
                    admin: {
                        components: {
                            Field: "@shopnex/import-export-plugin/rsc#CollectionField",
                        },
                        hidden: true,
                    },
                    required: true,
                },
                {
                    ...
                    admin: {
                        components: {
                            Field: "@shopnex/import-export-plugin/rsc#WhereField",
                        },
                    },
                    defaultValue: {},
                },
        ...
        },
        {
            ...
            admin: {
                components: {
                    Field: "@shopnex/import-export-plugin/rsc#Preview",
                },
            },
        },
    ];
